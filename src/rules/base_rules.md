...
- Base: `src/rules/base_rules.md`
- Language: `src/rules/typescript.md`, `src/rules/javascript.md`, `src/rules/python.md`
- Specialized: `src/rules/security.md`, `src/rules/testing.md`, `src/rules/hygiene.md`
